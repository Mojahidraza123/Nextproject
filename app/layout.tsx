...
import { Home, Phone, FileText, Users } from 'lucide-react';

const inter = Inter({ subsets: ['latin'] });

export const metadata: Metadata = {
  title: 'Dream Home Real Estate',
  description: 'Find your perfect property with Dream Home Real Estate',
};
        ...
        <header className="border-b">
          <nav className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="font-bold text-xl">Dream Home</span>
            </Link>
        ...
        <footer className="bg-gray-900 text-white">
          <div className="max-w-7xl mx-auto px-4 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                <h3 className="text-lg font-semibold mb-4">Dream Home</h3>
